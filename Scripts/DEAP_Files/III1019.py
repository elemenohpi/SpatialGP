...
pset.renameArguments(ARG0='Bz')
pset.renameArguments(ARG1='Bx')
pset.renameArguments(ARG2='MUM')
pset.renameArguments(ARG3='By')
# ############################# End Arguments
...
def evalSymbReg(individual, points):
    ...
    sqerrors = []
    for Bz, Bx, MUM, By in points:
        sqerrors.append((func(Bz, Bx, MUM, By) - (MUM * math.sqrt(Bx ** 2 + By ** 2 + Bz ** 2)))**2)
