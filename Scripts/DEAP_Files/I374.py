...
pset.renameArguments(ARG0='gamma')
pset.renameArguments(ARG1='I[2]')
# ############################# End Arguments
...
def evalSymbReg(individual, points):
    ...
    sqerrors = []
    for gamma, I[2] in points:
        sqerrors.append((func(gamma, I[2]) - (I[0] + I[1] + 2 * math.sqrt(I[0] * I[1]) * math.cos(gamma)))**2)
