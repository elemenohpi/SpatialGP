...
class I303(AbstractFitness):
    ...
    def evaluate(self, individual):
        ...
        for i in range(self.evaluation_count):
            n = self.data_handler.get_data(1)
            theta = self.data_handler.get_data(1)
            Istar0 = self.data_handler.get_data(1)
            measured = Istar0 * math.sin(n * theta / 2) ** 2 / math.sin(theta/2) ** 2
            inputs = [n, theta, Istar0]
