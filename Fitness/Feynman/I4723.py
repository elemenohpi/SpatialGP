...
class I4723(AbstractFitness):
    ...
    def evaluate(self, individual):
        ...
        for i in range(self.evaluation_count):
            # ======================================STARTPROBLEM===============================================
            ro = self.data_handler.get_data(1)
            Lambda = self.data_handler.get_data(1)
            p = self.data_handler.get_data(1)
            r = self.data_handler.get_data(1)

            inputs = [ro, Lambda, p, r]

            measured = math.sqrt(Lambda * p * r / ro)
            # ======================================ENDPROBLEM===============================================
