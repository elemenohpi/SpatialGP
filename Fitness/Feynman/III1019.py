...
class III1019(AbstractFitness):
    ...
    def evaluate(self, individual):
        ...
        for i in range(self.evaluation_count):
            # ======================================STARTPROBLEM===============================================
            Bz = self.data_handler.get_data(1)
            Bx = self.data_handler.get_data(1)
            MUM = self.data_handler.get_data(1)
            By = self.data_handler.get_data(1)

            inputs = [Bz, Bx, MUM, By]

            measured = MUM * math.sqrt(Bx ** 2 + By ** 2 + Bz ** 2)
            # ======================================ENDPROBLEM===============================================
